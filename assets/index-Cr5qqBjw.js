...
`,i4=R.div`
  ...
  position: relative;
  scroll-behavior: smooth;
`,o4=()=>{const{theme:e}=Ml();return y.jsxs(Rb,{theme:{...$b,mode:e},children:[y.jsx(Lb,{}),y.jsx(Y2,{basename:"/WuKonWeb4",children:y.jsx(s4,{})})]})},s4=()=>{const{theme:e}=Ml(),n=b.useRef(null),[i,o]=b.useState(!0),a=b.useRef(0),c=Ht().pathname==="/admin";return b.useEffect(()=>{const d=()=>{if(!n.current)return;const m=n.current.scrollTop;m<5?o(!0):o(!1),a.current=m},p=n.current;return p&&p.addEventListener("scroll",d,{passive:!0}),()=>{p&&p.removeEventListener("scroll",d)}},[]),b.useEffect(()=>{console.log("当前主题:",e),document.documentElement.setAttribute("data-theme",e),document.body.className=e},[e]),y.jsxs(i4,{ref:n,children:[!c&&y.jsx(Gf,{}),y.jsx(l4,{navVisible:i}),y.jsx(oR,{position:"top-center"})]})},a4=({children:e})=>et.isLogin?y.jsx(y.Fragment,{children:e}):y.jsx(ix,{to:"/login",replace:!0}),l4=({navVisible:e})=>{const n=Ht(),i=Oi(),o=n.pathname==="/login",a=n.pathname==="/profile",u=n.pathname==="/admin";return b.useEffect(()=>{const c=et.subscribe("login",p=>{console.log("登录状态变化 - 已登录:")}),d=et.subscribe("logout",()=>{console.log("登录状态变化 - 已登出"),i("/",{replace:!0})});return()=>{c(),d()}},[i]),b.useEffect(()=>{window.scrollTo(0,0)},[n.pathname]),b.useEffect(()=>{const c=()=>{const p=et.forceRefreshLoginStatus();console.log("检查登录状态:",p),!p&&!["/","/login","/hero","/app-showcase","/jindouyun","/interpreter","/parallel-universe"].includes(n.pathname)&&i("/login",{replace:!0})};["/","/login","/hero","/app-showcase","/jindouyun","/interpreter","/parallel-universe"].includes(n.pathname)||c()},[n.pathname,i]),y.jsxs(y.Fragment,{children:[!o&&!a&&!u&&y.jsx(n4,{$isVisible:e,children:y.jsx(QR,{})}),y.jsxs(E2,{children:[y.jsx(pn,{path:"/",element:y.jsxs(nr,{children:[y.jsxs("main",{children:[y.jsx(K0,{}),y.jsx(X0,{}),y.jsx(Fj,{}),y.jsx(Yj,{}),y.jsx(l3,{}),y.jsx(m3,{})]}),y.jsx(Mo,{}),y.jsx(or,{})]})}),y.jsx(pn,{path:"/login",element:y.jsx(nr,{children:y.jsx("main",{children:y.jsx(sA,{})})})}),y.jsx(pn,{path:"/hero",element:y.jsxs(nr,{children:[y.jsx("main",{children:y.jsx(K0,{})}),y.jsx(Mo,{}),y.jsx(or,{})]})}),y.jsx(pn,{path:"/app-showcase",element:y.jsxs(nr,{children:[y.jsx("main",{children:y.jsx(X0,{})}),y.jsx(Mo,{}),y.jsx(or,{})]})}),y.jsx(pn,{path:"/jindouyun",element:y.jsxs(nr,{children:[y.jsx("main",{children:y.jsx(KR,{})}),y.jsx(Mo,{}),y.jsx(or,{})]})}),y.jsx(pn,{path:"/interpreter",element:y.jsxs(nr,{children:[y.jsx("main",{children:y.jsx(_R,{})}),y.jsx(Mo,{}),y.jsx(or,{})]})}),y.jsx(pn,{path:"/parallel-universe",element:y.jsxs(nr,{children:[y.jsx(TR,{}),y.jsx(or,{})]})}),y.jsx(pn,{path:"/admin",element:y.jsx(a4,{children:y.jsx(nr,{children:y.jsx(b.Suspense,{fallback:y.jsx("div",{children:"加载中..."}),children:y.jsx(u4,{})})})})}),y.jsx(pn,{path:"*",element:y.jsx(ix,{to:"/",replace:!0})})]}),!o&&!u&&y.jsx(r4,{$isVisible:e,children:y.jsx(e4,{})})]})},u4=b.lazy(()=>AS(()=>import("./Admin-Db2vVGcs.js"),[]));console.log("使用的App版本: App.tsx");const c4=document.querySelectorAll("style[data-navigation-styles]");c4.forEach(e=>e.remove());document.body.classList.remove("is-scrolling");document.body.removeAttribute("data-nav-visible");PS.createRoot(document.getElementById("root")).render(y.jsx(o4,{}));export{We as V,et as a,lt as b,ke as c,R as d,Oi as e,y as j,b as r,Ml as u};
